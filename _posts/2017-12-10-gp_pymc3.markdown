...
The two key properties to remember are Gaussian under marginalisation
...
\begin{array}{c}
  {\Sigma_{11}} & {\Sigma_{12}}  \\
  {\Sigma_{21}^T} & {\Sigma_{22}}  \\
\end{array}
}\right]\right)$$

$$p(x_1) = \int p(x_1,x_2) dx_2 = \mathcal{N}(\mu_1, \Sigma_1) \label{marginal} \tag{1}$$

$$p(x_2) = \int p(x_1,x_2) dx_1 = \mathcal{N}(\mu_2, \Sigma_2)$$

and Gaussian under conditioning

$$p(x_1 \mid x_2) = \mathcal{N}(\mu_1 + \Sigma_{12}\Sigma_2^{-1}(x_2-\mu_2), 
\Sigma_1-\Sigma_{12}\Sigma_2^{-1}\Sigma_{12}^T) \label{conditioning} \tag{2}$$
...
<a href="https://www.cs.ubc.ca/~murphyk/MLbook/">An allround great book for probabilistic ML by Kevin Murphy</a><br>
